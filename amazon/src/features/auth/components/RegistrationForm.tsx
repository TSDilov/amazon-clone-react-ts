...
const RegistrationForm: FC = () => {
    const {
        text: name,
        shouldReturnError: nameHasError,
    ...
    const {
        ...
        shouldReturnError: confirmPasswordHasError,
    ...
    return (
        ...
        >
            ...
            <div style={{ marginTop: '30px' }}>
                <small>
                    <span>By creating an account, you agree to website</span>
                </small>
            </div>

            <div>
                <small>
                    <a href="#" style={{ textDecoration: 'none', color: '#0000ee' }}>
                        {' '}
                        Conditions of use
                    </a>{' '}
                    and {' '}
